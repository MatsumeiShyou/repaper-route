...
|---|------|-------|-------------|--------|-----------------|
| 1 | Lib & Utils Refactoring | Refactor 14 `any` types in `src/lib` and `src/utils` | none | PLANNED | |
| 2 | OS, Contexts & Hooks Refactoring | Refactor 10 `any` types in `src/os`, `src/contexts`, and `src/hooks` | Milestone 1 | PLANNED | |
