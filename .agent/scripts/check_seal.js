...
const isSealValid = status.includes(REQUIRED_SEAL) || status.includes('\uff59') || status.includes('ｙ');
...
function validateDebtStatus() {
    ...
    const isCritical = content.includes('#severity: critical') || content.includes('#severity: high');
    if (isCritical) {
