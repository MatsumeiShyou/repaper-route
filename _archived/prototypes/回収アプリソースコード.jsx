    ...
    <div className="flex flex-col h-screen bg-white text-sm font-sans text-gray-800 select-none">
      ...
      <header className="bg-gray-900 text-white p-2 flex justify-between items-center shadow-md z-50 relative">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="bg-white text-gray-900 px-3 py-1 rounded font-bold hover:bg-gray-100 transition">保存する</button>
        </div>
      </header>
            ...
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 p-4 animate-in fade-in zoom-in duration-200">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded p-2 text-sm focus:ring-2 focus:ring-emerald-500 outline-none bg-white" defaultValue={editModal.initialDriverName} id="edit-driver-name">
                ...
                <div>
                  ...
                  <select className="w-full border border-gray-300 rounded p-2 text-sm focus:ring-2 focus:ring-emerald-500 outline-none bg-white" defaultValue={editModal.initialVehicle} id="edit-vehicle-name">
                    <option value="">選択してください</option>
                ...
                <div className="pt-2 flex gap-2">
                  ...
                  <button onClick={() => { const name = document.getElementById('edit-driver-name').value; const vehicle = document.getElementById('edit-vehicle-name').value; handleSaveEdit(name, vehicle); }} className="flex-1 py-2 bg-emerald-600 text-white rounded text-sm font-bold hover:bg-emerald-700 shadow-sm">保存する</button>
                </div>
              </div>
            </div>
          </>
